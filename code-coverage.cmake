    ...
    if(CMAKE_BUILD_TYPE STREQUAL "coverage" OR CODE_COVERAGE)
        ...
        elseif(CMAKE_COMPILER_IS_GNUCXX)
            ...
            add_custom_target(${TARGET_NAME}-ccov
                ...
                COMMAND ${GENHTML_PATH} -o ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${TARGET_NAME}-lcov ${COVERAGE_CLEANED}
            ...
            add_custom_command(TARGET ${TARGET_NAME}-ccov POST_BUILD
                COMMAND ;
                COMMENT "Open ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${TARGET_NAME}-lcov/index.html in your browser to view the coverage report."
            )
        endif()
    endif()
endmacro()
