...
function(ClangFormat FORMAT_TARGET_NAME)
    if(CLANG_FORMAT)
...
if (IWYU_EXE)
    ...
    if(ADD_IWYU)
        ...
        message(STATUS "include-what-you-use DISABLED via 'ADD_IWYU' variable!")
    endif()
else()
...
if (CPPCHECK_EXE)
    ...
    if(ADD_CPPCHECK)
        ...
        message(STATUS "cppcheck DISABLED via 'ADD_CPPCHECK' variable!")
    endif()
else()
